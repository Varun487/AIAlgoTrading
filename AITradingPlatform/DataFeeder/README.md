...
- List all companies in DB ![DONE] 
	- Create an endpoint `listcompanies/` ![DONE]
- Get a particular company's details ![DONE]
	- Create an endpoint `companydetails/` ![DONE]
	- Validate request parameters ![DONE]
	- Filter data for request according to 'ticker' attribute ![DONE]
	- Return error message `No such data present. Please enter a valid company name` if no data found. ![DONE]
- Filter company according name, sector, ticker ![DONE]
    - Create an endpoint `filtercompany/` ![DONE]
    - Validate request parameters ![DONE]
    - Check request validity ![DONE]
    - Filter data according to 'sector' attribute ![DONE]
- Add a company ![DONE]
    - Create an endpoint `addcompany/` ![DONE]
