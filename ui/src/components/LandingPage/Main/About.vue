<template>
    ...
    <div class = "right2">
    <h5>  This is used to test strategies in real-time market 
        <br>scenarios after a strategy has performed well in back testing.
        <br>It tracks and evaluates orders generated by multiple strategies 
        <br>in real-time market conditions and provides various performance 
        <br>metrics for both strategies and orders. </h5>
        </div>
    <div style="clear: both;"></div>
    </div>
