...
10. REVIEW 3 ![componentincomplete]
11. Full working product ![componentincomplete]
    - UI
      - Remove token hardcoding
      - Fix CSS getting messed up when pressing back button
      - Nav buttons and filter for backtests and paper trades
    - Devops
      - SSL certification for server
      - Fix CORS issue with SSL certified server 
      - Fix deployed version of UI
12. Weekly reports ![docincomplete]
    - Submit + Get signature
13. Research paper ![docincomplete]
    - Extract data from DB ![varuncomplete]
    - Analysis on the backtest reports data ![varuncomplete]
    - Find useful insights ![allcomplete]
    - complete most of the research paper ![allincomplete]
14. Final Report Complete ![docincomplete]
    - Table of contents, list of figures, visualizations, research inferences remaining ![allincomplete]
15. FINAL REVIEW ![componentincomplete]
